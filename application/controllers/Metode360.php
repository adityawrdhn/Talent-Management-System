...
class Metode360 extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('Metode360model');
	}
	...
	public function index()
	{
		...
		if(!empty($cek) && $stts=='admin')
		{
			...
			$bc['hasil'] = $this->web_app_model->getAllData('metode360_penilaian');
			$bc['hasilpribadi'] = $this->web_app_model->getSelectedData('metode360_penilaian','pernr',$pernr);
			$bc['competency'] = $this->web_app_model->getSelectedData('hrm_competency','pernr',$pernr);
			
			$this->load->view('admin/bg_metode360',$bc);
		...
		elseif(!empty($cek) && $stts=='hr')
		{
			...
			$this->load->view('hr/bg_metode360',$bc);
			// $this->load->view('global/bg_footer',$bc);
		}
		elseif(!empty($cek) && $stts=='employee')
		{
			...
			$bc['hasilpribadi'] = $this->web_app_model->getSelectedData('metode360_penilaian','pernr',$pernr);
			$bc['competency'] = $this->web_app_model->getSelectedData('hrm_competency','pernr',$pernr);
			$this->load->view('employee/bg_metode360',$bc);
			// $this->load->view('global/bg_footer',$bc);
		}
		else
		{
