<?php
    ...
    $candidate['ddactive'] = 'Employee Sub Group'; // Current Menu Item
...
?>
	<div class="content-wrapper">
	      ...
	      <h1>
	        Master Data
	        <small>Employee Sub Group</small>
	      </h1>
	      <ol class="breadcrumb">
	        <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li class="active">Master Data</li>
            <li class="active">Employee Sub Group</li>
	      </ol>
	    </section>
                ...
                <?php echo $this->session->flashdata('sukses'); ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#add-data" onclick="add_data()" data-toggle="tab"><i class="fa fa-plus"></i>Add Employee Sub Group</a></li>
                        ...
                        <div class="tab-content no-padding">
                                ...
                                <!-- table-bordered table-striped -->
                                    <thead >
                                        <tr style="color:#b8c7ce;background:#2c3b41;">
                                            <th>ID Employee Sub Group</th>
                                            <th>Name Employee Sub Group</th>
                                            <th>Name Employee Group</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                          ...
                          <div class="chart tab-pane" id="add-data" style="position: relative; ">
                            <form method="post" action="<?php echo base_url(); ?>MasterData/saveEmsubgroup" id="formadd">
                              <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ID Employee Sub Group</label>
                                            <input type="text" class="form-control" name="perssubgid" value="<?php echo $getid;?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Name Employee Sub Group</label>
                                            <input type="text" class="form-control" name="persubg_text" placeholder="Name Employee Group...">
                                        </div>
                                        <div class="form-group">
                                            <label>Name Employee Group</label>
	...
	$(document).ready(function() {
	    ...
	    table = $('#table').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('MasterData/ajax_list_emsubgroup')?>",
	            "type": "POST"
	        },
	...
	function editForm(id)
	{
	    ...
	    $.ajax({
	        url : "<?php echo base_url('MasterData/ajax_edit_emsubgroup')?>/" + id,
	        type: "GET",
	        dataType: "JSON",
            ...
            $('[name="persubg_text"]').val(data.persubg_text);
	...
	function deleteForm(id)
	{
            ...
            success: function(data)
            {
                ...
                $('[name="perssubgid"]').val(data.perssubgid); // Set title to Bootstrap modal title
    	    },
	        error: function (jqXHR, textStatus, errorThrown)
	            {
    ...
    function deleteEmp()
    {
        ...
        var url;
        $.ajax({
            url : "<?php echo base_url('MasterData/ajax_delete_emsubgroup')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
            ...
            error: function (jqXHR, textStatus, errorThrown)
            {
                ...
                $('.modal-title-error').text("You can't delete this data! If you want to delete this data, you must change/delete employee sub group ID in employee table");
                $('#btndel').text('delete'); //change button text
                $('#btndel').attr('disabled',false); //set button enable 
   ...
   <div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" method="post" action="<?php echo base_url(); ?>MasterData/saveEmsubgroup" class="form-horizontal">
                <div class="modal-body">
                            
                            <div class="form-group">
                                <label class="control-label col-md-3">ID Employee Sub Group</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="perssubgid" value="" class="uneditable-input" readonly="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Name Employee Sub Group</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="persubg_text" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Name Employee Group</label>
                                <div class="col-md-9">
                                    <select name="persgid" class="form-control select2">
                                        <?php
                                            $this->load->database();
