<?php
    ...
    $candidate['ddactive'] = 'Employee Group'; // Current Menu Item
...
?>
                ...
                <?php echo $this->session->flashdata('sukses'); ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#add-data" onclick="add_data()" data-toggle="tab"><i class="fa fa-plus"></i>Add Employee Group</a></li>
                        ...
                        <div class="tab-content no-padding">
                          ...
                          <div class="chart tab-pane" id="add-data" style="position: relative; ">
                            <form method="post" action="<?php echo base_url(); ?>MasterData/saveEmgroup" id="formadd">
                              <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ID Employee Group</label>
                                            <input type="text" class="form-control" name="persgid" value="<?php echo $getid;?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Name Employee Group</label>
                                            <input type="text" class="form-control" name="persg_text" placeholder="Name Employee Group...">
                                        </div>
                                    </div>
                                </div>
                              </div>
	...
	$(document).ready(function() {
	    ...
	    table = $('#table').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('MasterData/ajax_list_emgroup')?>",
	            "type": "POST"
	        },
	...
	function editForm(id)
	{
	    ...
	    $.ajax({
	        url : "<?php echo base_url('MasterData/ajax_edit_emgroup')?>/" + id,
	        type: "GET",
	        dataType: "JSON",
            ...
            $('[name="persg_text"]').val(data.persg_text);
	...
	function deleteForm(id)
	{
            ...
            success: function(data)
            {
                ...
                $('[name="persgid"]').val(data.persgid); // Set title to Bootstrap modal title
    	    },
	        error: function (jqXHR, textStatus, errorThrown)
	            {
    ...
    function deleteEmp()
    {
        ...
        var url;
        $.ajax({
            url : "<?php echo base_url('MasterData/ajax_delete_emgroup')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('#btndel').text('deleted'); //cmmhange button text
                $('#btndel').attr('disabled',false); //set button enable 
            },
            error: function (jqXHR, textStatus, errorThrown)
            {
                // alert("You can't delete this data! If you want to delete this data, you must change/delete employee group ID in employee table");
                $('#ModalError').modal('show');
                $('.modal-title-error').text("You can't delete this data! If you want to delete this data, you must change/delete employee group ID in employee table");
   ...
   <div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" method="post" action="<?php echo base_url(); ?>MasterData/saveEmgroup" class="form-horizontal">
                <div class="modal-body">
                            
                            <div class="form-group">
                                <label class="control-label col-md-3">ID Employee Group</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="persgid" value="" class="uneditable-input" readonly="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Name Employee Group</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="persg_text" value="">
                                </div>
                            </div>
                        <!-- </div> -->
