<?php
    ...
    $candidate['ddactive'] = 'Personnel Area'; // Current Menu Item
...
?>
	<div class="content-wrapper">
	      ...
	      <h1>
	        Master Data
	        <small>Personnel Area</small>
	      </h1>
	      <ol class="breadcrumb">
	        <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
	        <li class="active">Master Data</li>
            <li class="active">Personnel Area</li>
          </ol>
	    </section>
                ...
                <?php echo $this->session->flashdata('sukses'); ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#add-data" onclick="add_data()" data-toggle="tab"><i class="fa fa-plus"></i>Add Personnel Area</a></li>
                        ...
                        <div class="tab-content no-padding">
                                ...
                                <!-- table-bordered table-striped -->
                                    <thead >
                                        <tr style="color:#b8c7ce;background:#2c3b41;">
                                            <th>ID Personnel Area</th>
                                            <th>Name Personnel Area</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                          ...
                          <div class="chart tab-pane" id="add-data" style="position: relative; ">
                            <form method="post" action="<?php echo base_url(); ?>MasterData/saveEmpersa" id="formadd">
                              <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ID Personnel Area</label>
                                            <input type="text" class="form-control" name="persaid" value="<?php echo $getid;?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Name Personnel Area</label>
                                            <input type="text" class="form-control" name="persa_text" placeholder="Name Personnel Area...">
                                        </div>
                                    </div>
                                </div>
                              </div>
	...
	$(document).ready(function() {
	    ...
	    table = $('#table').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('MasterData/ajax_list_Empersa')?>",
	            "type": "POST"
	        },
	...
	function editForm(id)
	{
	    ...
	    $.ajax({
	        url : "<?php echo base_url('MasterData/ajax_edit_Empersa')?>/" + id,
	        type: "GET",
	        dataType: "JSON",
            ...
            $('[name="persa_text"]').val(data.persa_text);
	...
	function deleteForm(id)
	{
            ...
            success: function(data)
            {
                ...
                $('[name="persaid"]').val(data.persaid); // Set title to Bootstrap modal title
    	    },
	        error: function (jqXHR, textStatus, errorThrown)
	            {
    ...
    function deleteEmp()
    {
        ...
        var url;
        $.ajax({
            url : "<?php echo base_url('MasterData/ajax_delete_Empersa')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
            ...
            error: function (jqXHR, textStatus, errorThrown)
            {
                ...
                $('.modal-title-error').text("You can't delete this data! If you want to delete this data, you must change/delete Personnel Area ID in employee table");
   ...
   <div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" method="post" action="<?php echo base_url(); ?>MasterData/saveEmpersa" class="form-horizontal">
                <div class="modal-body">
                            
                            <div class="form-group">
                                <label class="control-label col-md-3">ID Personnel Area</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="persaid" value="" class="uneditable-input" readonly="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Name Personnel Area</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="persa_text" value="">
                                </div>
                            </div>
                        <!-- </div> -->
