<?php
    ...
    $candidate['ddactive'] = 'Position'; // Current Menu Item
...
?>
                ...
                <?php echo $this->session->flashdata('sukses'); ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#add-data" onclick="add_data()" data-toggle="tab"><i class="fa fa-plus"></i>Add Position</a></li>
                        ...
                        <div class="tab-content no-padding">
                          ...
                          <div class="chart tab-pane" id="add-data" style="position: relative; ">
                            <form method="post" action="<?php echo base_url(); ?>MasterData/saveEmplans" id="formadd">
                              <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ID Position</label>
                                            <input type="text" class="form-control" name="plans" value="<?php echo $getid;?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Name Position</label>
                                            <input type="text" class="form-control" name="plans_text" placeholder="Name Position...">
                                        </div>
                                    </div>
                                </div>
                              </div>
	...
	$(document).ready(function() {
	    ...
	    table = $('#table').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('MasterData/ajax_list_Emplans')?>",
	            "type": "POST"
	        },
	...
	function editForm(id)
	{
	    ...
	    $.ajax({
	        url : "<?php echo base_url('MasterData/ajax_edit_Emplans')?>/" + id,
	        type: "GET",
	        dataType: "JSON",
            ...
            $('[name="plans_text"]').val(data.plans_text);
	...
	function deleteForm(id)
	{
            ...
            success: function(data)
            {
                ...
                $('[name="plans"]').val(data.plans); // Set title to Bootstrap modal title
    	    },
	        error: function (jqXHR, textStatus, errorThrown)
	            {
    ...
    function deleteEmp()
    {
        ...
        var url;
        $.ajax({
            url : "<?php echo base_url('MasterData/ajax_delete_Emplans')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
            ...
            error: function (jqXHR, textStatus, errorThrown)
            {
                ...
                $('.modal-title-error').text("You can't delete this data! If you want to delete this data, you must change/delete Position ID in employee table");
   ...
   <div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" method="post" action="<?php echo base_url(); ?>MasterData/saveEmplans" class="form-horizontal">
                <div class="modal-body">
                            
                            <div class="form-group">
                                <label class="control-label col-md-3">ID Position</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="plans" value="" class="uneditable-input" readonly="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Name Position</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="plans_text" value="">
                                </div>
                            </div>
                        <!-- </div> -->
