<?php
    ...
    $candidate['ddactive'] = 'Job'; // Current Menu Item
...
?>
                ...
                <?php echo $this->session->flashdata('sukses'); ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#add-data" onclick="add_data()" data-toggle="tab"><i class="fa fa-plus"></i>Add Job</a></li>
                        ...
                        <div class="tab-content no-padding">
                          ...
                          <div class="chart tab-pane" id="add-data" style="position: relative; ">
                            <form method="post" action="<?php echo base_url(); ?>MasterData/saveEmjob" id="formadd">
                              <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ID Job</label>
                                            <input type="text" class="form-control" name="jobid" value="<?php echo $getid;?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Name Job</label>
                                            <input type="text" class="form-control" name="job_text" placeholder="Name Job...">
                                        </div>
                                    </div>
                                </div>
                              </div>
	...
	$(document).ready(function() {
	    ...
	    table = $('#table').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('MasterData/ajax_list_Emjob')?>",
	            "type": "POST"
	        },
	...
	function editForm(id)
	{
	    ...
	    $.ajax({
	        url : "<?php echo base_url('MasterData/ajax_edit_Emjob')?>/" + id,
	        type: "GET",
	        dataType: "JSON",
            ...
            $('[name="job_text"]').val(data.job_text);
	...
	function deleteForm(id)
	{
            ...
            success: function(data)
            {
                ...
                $('[name="jobid"]').val(data.jobid); // Set title to Bootstrap modal title
    	    },
	        error: function (jqXHR, textStatus, errorThrown)
	            {
    ...
    function deleteEmp()
    {
        ...
        var url;
        $.ajax({
            url : "<?php echo base_url('MasterData/ajax_delete_Emjob')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
            success: function(data)
            ...
            error: function (jqXHR, textStatus, errorThrown)
            {
                ...
                $('.modal-title-error').text("You can't delete this data! If you want to delete this data, you must change/delete employee Job ID in employee table");
   ...
   <div class="modal fade" id="modal_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="form" method="post" action="<?php echo base_url(); ?>MasterData/saveEmjob" class="form-horizontal">
                <div class="modal-body">
                            
                            <div class="form-group">
                                <label class="control-label col-md-3">ID Job</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="jobid" value="" class="uneditable-input" readonly="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3">Name Job</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="job_text" value="">
                                </div>
                            </div>
                        <!-- </div> -->
