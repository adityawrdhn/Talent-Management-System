      <footer class="main-footer">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
          <li><a href="#control-sidebar-home-tab" data-toggle="tab"><i class="fa icon-help-circled-1"></i></a></li>
          <li><a href="#control-sidebar-settings-tab" data-toggle="tab"><i class="fa icon-wrench"></i></a></li>
        </ul>
        <!-- Tab panes -->
