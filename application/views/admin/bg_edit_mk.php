    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li ><a href="#daftar" data-toggle="tab">Daftar Mata Kuliah</a></li>
          <li><a href="#tambah" data-toggle="tab">Tambah Mata Kuliah</a></li>
          <li class="active"><a href="#edit" data-toggle="tab">Edit Mata Kuliah</a></li>
		...
		<tr style="color:#b8c7ce;background:#2c3b41;">			                
          ...
          <div class="active tab-pane" id="edit">
			...
			<table>
			<?php
			foreach($edit_mk->result_array() as $m)
			{
			?>
			<tr>
